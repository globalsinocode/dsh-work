...
**当前证据状态：** PF-01～PF-06 代码级记录已存在。此前 P2 只有口头结论，未提供版本、身份、环境和 Run/Attempt 等原始记录；它发生在当前平台能力形成之前，不能作为 PF-07 的 P2 证据。2026-09-14 的真实 DSH 验收使用合成身份，也早于 PF-01～PF-06。PF-07 应按当前目标版本重新执行所需真实场景并留证，发布门禁仍未通过。
