...
const before = { id: 'a', status: 'draft', name: 'n', description: 'd', welcomeMessage: 'w', examplePrompts: ['e'],
  owner: 'u', department: 'd', visibility: 'all', roleIds: ['r'], dataScopes: ['s'], systemPrompt: 'system', maxTokens: 1000,
...
test('complete normalized diff cannot smuggle a protected field or change object identity', () => {
  ...
  for (const field of ['systemPrompt', 'roleIds', 'dataScopes', 'tools', 'skills', 'maxTokens', 'owner', 'department', 'visibility']) {
