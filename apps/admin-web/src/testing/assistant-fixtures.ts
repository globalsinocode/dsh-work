...
export function conversationFixture(): AdminConversation {
  return { id: 'admin-session-00000000-0000-4000-8000-000000000001', title: '安装 Skill',
    ...
    installations: [{ id: 'install-1', runId: 'run-1', source: 'https://example.org/skill.zip', resolvedUrl: null, resolvedRef: null, status: 'pending', skillId: null, compatibilityStatus: 'compatible', planSha256: 'd'.repeat(64),
